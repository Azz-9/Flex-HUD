...
public class ConfigIntFieldWidget extends CustomEditBox implements TrackableChange, DataGetter<Integer>, ResetAware {
	...
	public ConfigIntFieldWidget(Font font, int width, int height, ConfigInteger variable, List<Observer> observers, @Nullable Function<Integer, Tooltip> getTooltip) {
		super(font, 0, 0, width, height, Component.translatable("flex_hud.integer_field"));
	...
	public void setIncreaseButton(ImageButton increaseButton) {
		this.increaseButton = increaseButton;
		increaseButton.active = getData() < MAX_VALUE;
	}

	public void setDecreaseButton(ImageButton decreaseButton) {
