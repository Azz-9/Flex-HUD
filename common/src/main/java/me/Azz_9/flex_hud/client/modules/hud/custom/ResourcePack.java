...
public class ResourcePack extends AbstractTextModule implements TickableModule {
	...
	public void render(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
		...
		if (selectedPackTitleWidget != null) {
			...
			selectedPackTitleWidget.extractWidgetRenderState(graphics, 0, 0, deltaTracker.getGameTimeDeltaTicks());
		}
		if (showDescription.getValue() && selectedPackDescriptionWidget != null) {
			...
			selectedPackDescriptionWidget.extractWidgetRenderState(graphics, 0, 0, deltaTracker.getGameTimeDeltaTicks());
		}
