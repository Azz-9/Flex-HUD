...
public class CommonClass {
	...
	public static void init() {
		...
		if (DEBUG) {
			printPerfTesterTimesKeyBind = Services.PLATFORM.registerKeyMapping(new KeyMapping("Perf tester", InputConstants.Type.KEYBOARD, InputConstants.KEY_I, FLEX_HUD));
		}
	}
