...
public class XaeroCompat {
	...
	private static XaeroCompatBridge instance;

	public interface XaeroCompatBridge {
		boolean isXaerosMinimapLoaded();
	}

	public static void setInstance(XaeroCompatBridge bridge) {
		instance = bridge;
	}

	public static boolean isXaerosMinimapLoaded() {
		return instance != null && instance.isXaerosMinimapLoaded();
	}
