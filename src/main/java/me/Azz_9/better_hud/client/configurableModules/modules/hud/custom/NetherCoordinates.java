...
public class NetherCoordinates extends AbstractTextElement {
	private ConfigBoolean onlyWhenInOverworld = new ConfigBoolean(false, "better_hud.nether_coordinates.config.only_show_in_overworld");
	...
	public void init() {
		...
		this.enabled.setConfigTextTranslationKey("better_hud.nether_coordinates.config.enable");
	}

	@Override
	public Text getName() {
		return Text.translatable("better_hud.nether_coordinates");
	}
