...
public class MemoryUsage extends AbstractHudElement {
	...
	public void init() {
		...
		this.enabled.setConfigTextTranslationKey("better_hud.memory_usage.config.enable");
	}
	...
	@Override
	public Text getName() {
		return Text.translatable("better_hud.memory_usage");
	}
