...
public class Playtime extends AbstractHudElement {
	...
	public void render(DrawContext context, RenderTickCounter tickCounter) {
		...
		context.drawText(client.textRenderer, elapsedTime, 0, 0, getColor(), this.shadow);
			...
			protected void init() {
				...
				this.addAllEntries(
						new ToggleButtonEntry.Builder()
								...
								.setText(Text.translatable("better_hud.playtime.config.enable"))
								.build(),
						new ToggleButtonEntry.Builder()
								.setToggleButtonWidth(buttonWidth)
								.setToggled(shadow)
				...
				this.addAllEntries(
						...
						new ToggleButtonEntry.Builder()
								.setToggleButtonWidth(buttonWidth)
								.setToggled(showPrefix)
								.setDefaultValue(true)
								.setOnToggle(toggled -> showPrefix = toggled)
								.setText(Text.translatable("better_hud.playtime.config.show_prefix"))
								.build()
				);
			}
		};
