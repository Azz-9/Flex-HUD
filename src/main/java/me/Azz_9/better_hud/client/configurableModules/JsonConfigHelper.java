...
public class JsonConfigHelper {
	...
	public Compass compass = new Compass(-MinecraftClient.getInstance().getWindow().getScaledWidth() / 4.0, 0, AbstractHudElement.AnchorPosition.CENTER, AbstractHudElement.AnchorPosition.START);
	...
	public static List<Configurable> getConfigurableModules() {
		return new ArrayList<>(getMovableModules());
	}
}
