...
public class WeatherDisplay extends AbstractBackgroundElement {
	...
	public void init() {
		this.height = 16;
		this.width = 16;
		this.enabled.setConfigTextTranslationKey("better_hud.weather_display.config.enable");
	}

	@Override
	public Text getName() {
		return Text.translatable("better_hud.weather_display");
	}
	...
	private static @NotNull String getWeatherIconPath(MinecraftClient client) {
		String path;
		if (Better_hudClient.isInMoveElementScreen || client.world == null) {
