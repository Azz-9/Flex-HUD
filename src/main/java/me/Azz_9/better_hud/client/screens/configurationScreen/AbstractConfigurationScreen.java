...
public abstract class AbstractConfigurationScreen extends AbstractCallbackScreen implements Observer {
	...
	public static class CyclingButtonEntry<E extends Enum<E>> extends ScrollableConfigList.AbstractConfigEntry {
		...
		public <T> CyclingButtonEntry(
			...
			super(resetButtonSize, text);
			cyclingButtonWidget = new ConfigCyclingButtonWidget<>(cyclingButtonWidth, cyclingButtonHeight, initialValue, onValueChange, observers, disableWhen);
