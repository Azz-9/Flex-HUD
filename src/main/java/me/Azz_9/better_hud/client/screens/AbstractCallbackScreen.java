...
public abstract class AbstractCallbackScreen extends AbstractBackNavigableScreen {
	...
	protected void init() {
		...
		callbackDiscardButton = ButtonWidget.builder(Text.translatable("better_hud.global.config.quit_and_discard"), (btn) -> this.cancel())
				.dimensions(
		...
		callbackCancelButton = ButtonWidget.builder(Text.translatable("better_hud.global.config.cancel"), (btn) -> setCallbackScreen(false))
				.dimensions(
		...
		int buttonsGap = 10;
		cancelButton = ButtonWidget.builder(Text.translatable("better_hud.global.config.cancel"), (btn) -> onCancelButtonClick())
				.dimensions(
		...
		saveButton = ButtonWidget.builder(Text.translatable("better_hud.global.config.save_and_quit"), (btn) -> saveAndClose())
				.dimensions(
