...
public class NetherCoordinates extends AbstractTextModule {
	...
	public void render(DrawContext context, RenderTickCounter tickCounter) {
		...
		if (shouldNotRender() || !Flex_hudClient.isInMoveElementScreen && (player == null || !player.getWorld().getRegistryKey().equals(World.OVERWORLD) && this.onlyWhenInOverworld.getValue() || !player.getWorld().getRegistryKey().equals(World.OVERWORLD) && !player.getWorld().getRegistryKey().equals(World.NETHER))) {
			return;
		}
		...
		if (Flex_hudClient.isInMoveElementScreen) {
			...
			if (player.getWorld().getRegistryKey().equals(World.OVERWORLD)) {
				...
				dimension = StringUtil.capitalize(player.getWorld().getRegistryKey().getValue().getPath());
			}
		}
