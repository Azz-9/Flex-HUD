...
record ModifierPart(String displayText, int width, int color, Component tooltip, int startX, int index) {
}

record HoverTarget(Component tooltip) {
}
...
record ModifierPickerEntry(Modifier<?, ?> modifier, Bounds bounds, Component tooltip) {
}
