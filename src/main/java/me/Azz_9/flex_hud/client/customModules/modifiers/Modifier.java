...
public class Modifier<I, R> {
	...
	public record UiMetadata(EditorKind editorKind,
		...
		public Component getName(String modifierKey) {
			return Component.translatable("flex_hud.custom_modules.modifier.name." + modifierKey);
		}

		public Component getDescription(String modifierKey) {
			return Component.translatable("flex_hud.custom_modules.modifier.description." + modifierKey);
		}
	}
	...
	public record ParameterDefinition(String key, ParameterKind kind) {
		...
		public Component getName(String modifierKey) {
			return Component.translatable("flex_hud.custom_modules.modifier.parameter." + key);
		}
	}
